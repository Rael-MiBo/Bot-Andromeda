...
const client = new Discord.Client({
  intents: [Object.keys(GatewayIntentBits), Discord.GatewayIntentBits.Guilds],
...
client.on("guildBanAdd", (member) => {
  ...
  const embed = new Discord.EmbedBuilder()
    ...
    .setDescription(
      `<:1288discordrole:1028430849915498606> ‣ Informações do usuario:\n > **Membro:${member.user}** \n > **ID:${member.user.id}**`
    )
...
client.on("guildBanRemove", (member) => {
  ...
  const embed = new Discord.EmbedBuilder()
    ...
    .setThumbnail(`${client.user.displayAvatarURL({ size: 2048 })}`)
    .setTitle(
      `<:1288discordrole:1028430849915498606> ‣ LOG | Usuario Desbanido.`
    )
    .setDescription(
      `<:1288discordrole:1028430849915498606> ‣ Informações do usuario:\n > **Membro:${member.user}** \n > **ID:${member.user.id}**`
    )
